    ...
    <>
      <div className="w-screen h-screen">
        <div className="w-full h-12 bg-primary fixed flex flex-row justify-end  ">
          <NavLink
            to="/"
            className="text-white text-2xl w-full pt-2 pl-2 h-fit flex justify-start items-center"
          >
            NFTWeb
          </NavLink>
          {account.currentAccount == null ? (
            ...
            <div className="mr-8 w-1/3 flex justify-center items-center">
              Hey,{" "}
          ...
          <div className="w-1/2 h-1/2 bg-secondary-3 flex flex-col justify-evenly items-center">
            ...
            <form className="w-full h-1/2 flex flex-col justify-evenly items-center">
              ...
              <input
                ...
                type="text"
                className="w-2/3 m-4 p-2"
                readOnly
                value={sellerId}
              />
            </form>
            <button
              className="w-1/3 h-12 bg-secondary-2 flex justify-center items-center"
              onClick={create}
            >
              Register
            </button>
